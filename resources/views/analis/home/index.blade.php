            ...
            <div class="col-lg-8">
                <div class="row">
                  ...
                  dropdown-menu-arrow">
                    ...
                    <!-- Revenue Card -->
                    <div class="col-xxl-4 col-md-6">
                        <div class="card info-card pemeriksaan-card">
                  ...
                  dropdown-menu-arrow">
                    ...
                    <div class="col-xxl-4 col-xl-12">
                        ...
                        <div class="card info-card omsite-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Omsite <span>| This Year</span></h5>
                                <div class="d-flex align-items-center">
                  ...
                  dropdown-menu-arrow">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Proses Pemeriksaan <span>| Today</span></h5>
