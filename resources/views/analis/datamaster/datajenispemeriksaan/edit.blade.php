                ...
                <div class="col-lg-12">
                    <div class="card ">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Edit Data Jenis Pemeriksaan</h5>
                            ...
                            @endif
                            <form class="row g-3" action="{{ route('datajenispemeriksaan.update', $data->id) }}"
                                method="POST">
                                @method('PUT');
                                @csrf
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="nilai_rujukan"
                                        value="{{ $data->nilai_rujukan }}" required>
                                </div>
                                <div class="col-md-12">
