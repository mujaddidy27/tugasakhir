...
<head>
    <meta charset="utf-8">
    <title>SiLabWK | {{ $title }} </title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Free HTML Templates" name="keywords">
    <meta content="Free HTML Templates" name="description">

    <!-- Favicon -->
    <link href="{{ asset('landing/img/favwk.png') }}" rel="icon">
                ...
                <div class="col-md-6 text-center text-lg-start mb-2 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        <a class="text-decoration-none text-body pe-3"
                            href="https://wa.me/6285257244875?text=Hallo...!%2C%20Jaga%20Kesehatan%20Anda%20Bersama%20Kami%20Laboratorium%20Wijaya%20Kusuma."><i
                                class="bi bi-telephone me-2"></i>+62 852-5724-4875</a>
                        <span class="text-body">|</span>
                        <a class="text-decoration-none text-body px-2"
                            href="mailto:laboratoriumklinikwijayakusuma@gmail.com"><i
                                class="bi bi-envelope me-2">laboratoriumklinikwijayakusuma@gmail.com</i></a>
                    </div>
                </div>
